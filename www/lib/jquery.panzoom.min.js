...
(function (global, factory) {
    ...
    Panzoom.prototype = {
        ...
        zoom: function (scale, opts) {
            ...
            if (focal && !options.disablePan) {
                ...
                if (!this.isSVG) {
                    ...
                    clientX -= options.deviceWidth / 2;
                    clientY -= options.deviceHeight / 2;
                }
        ...
        _getMiddle: function (touches) {
            ...
            var touch2 = touches[1];
            return {
                clientX: ((touch2.pageX - touch1.pageX) / 2) + touch1.pageX,
                clientY: ((touch2.pageY - touch1.pageY) / 2) + touch1.pageY
            };
        },
